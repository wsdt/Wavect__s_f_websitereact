...
export class CarouselPrevBtn extends PreviousButton {
    public render() {
        ...
        return (
            <button style={defaultButtonStyles(disabled)} disabled={disabled} onClick={this.handleClick} aria-label="previous" type="button">
...
export class CarouselNextBtn extends NextButton {
    public render() {
        const { wrapAround, slidesToShow, currentSlide, cellAlign, slideCount } = this.props
        ...
        return (
            <button style={defaultButtonStyles(disabled)} disabled={disabled} onClick={this.handleClick} aria-label="next" type="button">
